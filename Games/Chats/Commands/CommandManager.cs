...
using ButterflyEmulator.HabboHotel.Chats.Commands.User.Room;
using Core.Language;
...
using Permissions;
using Rooms;
using Staff.Administration;
using Staff.Animation;
using Staff.Gestion;
using Staff.Moderation;
using User.Build;
using User.Casino;
using User.Info;
using User.Inventory;
using User.Premium;
using User.Room;
using User.RP;
using User.Several;
...
public static class CommandManager
{
    ...
    public static void RegisterCommand()
    {
        ...
        Register(178, new Colour());
        Register(179, new EjectAll());
    }
}
