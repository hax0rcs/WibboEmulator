namespace WibboEmulator.Games.Catalogs.Builders;

using Core.Language;
using Users;
using WebSocketSharp;

public class CatalogBuildersPage
{
    ...
    public Dictionary<int, CatalogBuildersItem> Items { get; private set; }
    public Dictionary<int, CatalogBuildersItem> ItemOffers { get; private set; }
    ...
    public CatalogBuildersPage(int id, int parentId, bool enabled, string caption, string pageLink, int icon, string requiredRight,
        string template, string pageStrings1, string pageStrings2, string captionEn, string captionBr, string pageStrings2En,
        string pageStrings2Br, bool isPremium, Dictionary<int, CatalogBuildersItem> items)
    {
        this.Id = id;
    ...
    public CatalogBuildersItem GetItem(int id)
    {
