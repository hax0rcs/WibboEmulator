...
public class UserFactory
{
    ...
    public static User GenerateUser(UserEntity user, UserStatsEntity userStats, bool isFirstConnexionToday, int ignoreAllExpire)
    {
        ...
        var kisses = userStats.Kisses;
        var receivedKisses = userStats.ReceivedKisses;
        var receivedDuckets = userStats.ReceivedDuckets;
        var level = userStats.Level;
        var bcItemsUsed = userStats.BcItemsUseds;
