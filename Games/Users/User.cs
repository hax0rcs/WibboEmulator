...
using Chats.Filter;
using Chats.Logs;
using Communication.Packets.Outgoing.Help;
...
using Communication.Packets.Outgoing.WibboTool;
using Core;
...
public class User : IDisposable, IEquatable<User>
{
    ...
    //BUILDERS CLUB
    public int BCItemsUsed { get; set; }
        ...
        Language langue, int ignoreAllExpire, bool ignoreRoomInvite, bool cameraFollowDisabled, int gamePointsMonth, int bannerId, string discordId, string discordAvatar, string discordBanner, int bcItemsUsed, int bcItemsMax)
    {
        ...
        this.Langue = langue;
        this.BCItemsUsed = bcItemsUsed;
        this.BCItemsMax = bcItemsMax;
    ...
    public bool EnterRoom(Room room)
    {
        ...
        this.Client.SendPacket(room.RoomData.TileFlow ? HeightMapComposer.WriteFlowHeightMap(room, 0.0) : room.GameMap.Model.SerializeRelativeHeightmap());
