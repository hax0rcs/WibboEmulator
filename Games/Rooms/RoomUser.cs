...
public class RoomUser : IEquatable<RoomUser>
{
    ...
    public Point Point => new(this.X, this.Y);
    ...
    // Tile Builds
    public bool TileCopy { get; set; }
    public bool TileMove { get; set; }
    ...
    public List<ItemCopy> ItemsCopy { get; set; }
    public List<ItemMove> ItemsMove { get; set; }
    ...
    public List<string> WhisperGroupUsers { get; set; }
    ...
    public RoomUser(int userId, int roomId, int virtualId, Room room)
    {
        ...
        this.WhisperGroupUsers = [];
        this.ItemsCopy = [];
        this.TileCopy = false;
        this.ItemsMove = [];
        this.TileMove = false;
        this.OverrideHeight = false;
    ...
    public void ForceRot(int rotation, bool onlyHead = false, bool ignoreWalk = false)
    {
        if (this.ContainStatus("lay") || (this.IsWalking && !ignoreWalk))
        {
            return;
