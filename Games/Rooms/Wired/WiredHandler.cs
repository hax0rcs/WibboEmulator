...
public class WiredHandler(Room room)
{
    ...
    public event EventHandler<ItemTriggeredEventArgs> TrgChronoUp;
    ...
    public void TriggerChronoUp(Item item, int timer) => this.TrgChronoUp?.Invoke(null, new(null, item, timer.ToString()));
