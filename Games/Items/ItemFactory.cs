...
{
    public static Item CreateSingleItemNullable(IDbConnection dbClient, ItemData data, User user, string extraData, int limitedNumber = 0, int limitedStack = 0, bool isBuilderClub = false)
    {
        if (data == null)
        {
    ...
    public static FurniInteractor CreateInteractor(Item item) => item.ItemData.InteractionType switch
    {
        ...
        InteractionType.PILE_WALK => new InteractorPileWalkable(),
        ...
        InteractionType.CHRONO_TIMER_UP => new InteractorUpChrono(),
        ...
        InteractionType.TERMINAL => new InteractorTerminal(),
