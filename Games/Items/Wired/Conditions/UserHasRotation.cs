...
public class UserHasRotation : WiredConditionBase, IWiredCondition, IWired
{
    public UserHasRotation(Item item, Room room) : base(item, room, (int)WiredConditionType.ACTOR_COMPARE_ROTATION) => this.DefaultIntParams(0, 0);
