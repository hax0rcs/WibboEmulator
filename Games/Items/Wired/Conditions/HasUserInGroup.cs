...
public class HasUserInGroup : WiredConditionBase, IWiredCondition, IWired
{
    ...
    public HasUserInGroup(Item item, Room room) : base(item, room, (int)WiredConditionType.ACTOR_IS_GROUP_MEMBER) => this.DefaultIntParams(0, 0, 0);
    ...
    public bool AllowsExecution(RoomUser user, Item item)
    {
        ...
        if (!verifyIsMember && !verifyIsAdmin && !verifyIsOwn)
        {
            return false;
        }
