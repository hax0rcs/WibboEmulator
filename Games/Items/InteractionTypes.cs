...
public class InteractionTypes
{
    public static InteractionType GetTypeFromString(string pType) => pType switch
    {
        ...
        "wf_upcounter" => InteractionType.CHRONO_TIMER_UP,
        ...
        "wf_trg_afkkkdormeur" => InteractionType.TRIGGER_USER_IDLE,
        "wf_trg_user_performs_action" => InteractionType.TRIGGER_USER_ACTION,
        "wf_trg_timer" => InteractionType.TRIGGER_PERIODICALLY,
        "wf_trg_clock_counter" => InteractionType.TRIGGER_CHRONO_UP,
        ...
        "wf_cnd_match_snap" => InteractionType.CONDITION_STATE_POS,
        "wf_cnd_stuff_is" => InteractionType.CONDITION_STUFF_IS,
        "wf_cnd_team_has_score" => InteractionType.CONDITION_TEAM_HAS_SCORE,
        "wf_cnd_team_has_rank" => InteractionType.CONDITION_TEAM_HAS_RANK,
        "wf_cnd_has_altitude" => InteractionType.CONDITION_FURNI_ALTITUDE,
        ...
        "terminal" => InteractionType.TERMINAL,
        ...
        "pilewalk" => InteractionType.PILE_WALK,
        ...
        "wf_act_life_change" => InteractionType.ACTION_CHANGE_LIFES,
        "wf_act_control_clock" => InteractionType.ACTION_CONTROL_CHRONO,
        "wf_act_user_sit" => InteractionType.ACTION_USER_SIT,
        "wf_act_user_lay" => InteractionType.ACTION_USER_LAY,
        "wf_act_user_stand" => InteractionType.ACTION_USER_STAND,
        "wf_act_user_rotation" => InteractionType.ACTION_USER_ROTATION,
        "wf_act_set_altitude" => InteractionType.ACTION_ALTITUDE,
        "wf_cnd_counter_time_matches" => InteractionType.CONDITION_CHRONO_COMPARE,
        "wf_cnd_compare_highscore" => InteractionType.CONDITION_COMPARE_HIGHSCORE,
        "wf_cnd_actor_dir" => InteractionType.CONDITION_ACTOR_HAS_ROTATION,
        "wf_cnd_not_actor_dir" => InteractionType.CONDITION_ACTOR_NOT_HAS_ROTATION,
