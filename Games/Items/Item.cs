...
using Rooms.Map;
using Rooms.Map.Movement;
using Wired.Interfaces;
...
public class Item : IEquatable<Item>
{
    ...
    //BUILDERS
    public bool IsBuilderClub { get; set; }
    ...
    public event EventHandler<ItemTriggeredEventArgs> OnChronoUp;
        ...
        string wallCoord, Room room, string colour1 = "ffffff", string colour2 = "ffffff", bool isBuilderClub = false)
    {
        if (ItemManager.GetItem(baseItemId, out var data))
        {
            ...
            this.IsBuilderClub = isBuilderClub;
    ...
    public void ChronoUp(Item item, int time) => this.OnChronoUp?.Invoke(this, new(null, item, time.ToString()));
