...
internal sealed class CatalogBuildersItemDao
{
    internal static List<CatalogBuildersItemEntity> GetAll(IDbConnection dbClient) => dbClient.Query<CatalogBuildersItemEntity>(
...
public class CatalogBuildersItemEntity
{
