...
internal sealed class CatalogBCIndexComposer : ServerPacket
{
    public CatalogBCIndexComposer(GameClient session, ICollection<CatalogBuildersPage> pages, string mode) : base(
        ServerPacketHeader.BUILDERS_PAGE_LIST)
    {
    ...
    public void WriteRootIndex(GameClient session, ICollection<CatalogBuildersPage> pages)
    {
    ...
    public void WriteNodeIndex(CatalogBuildersPage page, int treeSize, Language langue)
    {
    ...
    public void WritePage(CatalogBuildersPage page, int treeSize, Language langue)
    {
        this.WriteBoolean(true);
        this.WriteInteger(page.Icon);
    ...
    public static int CalcTreeSize(GameClient session, ICollection<CatalogBuildersPage> pages, int parentId)
    {
        var i = 0;
