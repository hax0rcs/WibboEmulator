...
using Incoming.BuildersClub;
using Incoming.Camera;
using Incoming.Campaign;
using Incoming.Catalog;
using Incoming.Groups;
using Incoming.Guide;
...
using Incoming.RolePlay;
using Incoming.RolePlay.Troc;
...
using Incoming.Rooms.Nux;
using Incoming.Rooms.Polls;
using Incoming.Rooms.Settings;
using Incoming.Settings;
using Incoming.Televisions;
using Incoming.Users;
using Incoming.WibboTool;
...
public static class PacketManager
{
    ...
    private static void RegisterCustom()
    {
        ...
        IncomingPackets.Add(ClientPacketHeader.USER_KISS, new KissUserEvent());
        IncomingPackets.Add(ClientPacketHeader.USER_GIVE_STAR, new UserGiveStarEvent());
    }
    ...
    private static void RegisterRoomEngine()
    {
        ...
        IncomingPackets.Add(ClientPacketHeader.BUILDERS_CLUB_PLACE_ROOM_ITEM, new PlaceBuilderObjectEvent());
        IncomingPackets.Add(ClientPacketHeader.BUILDERS_CLUB_QUERY_FURNI_COUNT, new BuildersClubQueryFurniCountEvent());
    }
    ...
    private static void RegisterRoomAvatar()
    {
        ...
        IncomingPackets.Add(ClientPacketHeader.UNIT_CHAT_WHISPER_GROUP, new WhisperGroupEvent());
    }
